...
class DatastoreManager(object):
    ...
    def create_client(self, project_id):
        ...
        if self.lcp == 'dev':
            ...
            if path.exists('/Users/javier/.google_keys/exambae-QA.json'):
                credentials = service_account.Credentials.from_service_account_file(
                    '/Users/javier/.google_keys/exambae-QA.json')
            else:
                import os
                key_file = os.environ.get('GOOGLE_SERVICE_ACCOUNT')
            ...
            # the reason for this is the key file does not work locally.
            # it only works when deployed to app engine or compute engine.
            import os
            from google.oauth2 import service_account
    ...
    def get_entities(self, entity_names):
        ...
        for entity_name  in entity_names:
            keys.append( self.client.key(self.kind_name, entity_name) )
